...
const updateCartItem = (itemId, quantity) => {
  let cartData = structuredClone(cartItems); // Deep clone of current cart
  cartData[itemId] = quantity;              // Update quantity
  setCartItems(cartData);                   // Set new cart state
  toast.success("Updated cart");            // Toast notification
};
